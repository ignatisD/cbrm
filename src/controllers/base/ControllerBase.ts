...
export default abstract class ControllerBase<C extends IBusinessBase> extends Controller<C> implements IControllerBase {
    ...
    async retrieve(req: Request, res: Response): Promise<void> {
        try {
            const searchTerms = SearchTerms.fromRequest(req);
    ...
    async findById(req: Request, res: Response): Promise<void> {
        try {
            const searchTerms = SearchTerms.fromRequest(req).setId(req.params._id);
    ...
    async updateMany(req: Request, res: Response): Promise<void> {
        try {
            ...
            const searchTerms = SearchTerms.fromScratch().setFilters(req.body.filters);
    ...
    async deleteManyById(req: Request, res: Response): Promise<void> {
        const response = new JsonResponse();
        try {
            const searchTerms = SearchTerms.fromScratch().setFilter("_id", req.body);
    ...
    private _applyPopulates(method: keyof ControllerMethodsPopulates, terms: ISearchTerms) {
